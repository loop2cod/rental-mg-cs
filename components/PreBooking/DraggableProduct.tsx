    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-xs text-muted-foreground">{product.categoryName || "Table"}</p>
          <p className="text-xs text-muted-foreground">Quantity: {product.quantity || 10}</p>
        </div>
      </div>
      <div className="flex flex-col items-end gap-1">
        <p className="text-base font-semibold">₹{product.unit_cost || 110} / day</p>
